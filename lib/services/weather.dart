              ...
              const apiKeyAqicn = '8bcf4e85c22d8521802ca262476e3713994a35ac'; // api Key from https://aqicn.org
              const apiKeyOpenWeatherMap = 'ae1197abd618e8096153626ed444bb89'; // api key from https://openweathermap.org/
              ...
              class WeatherModel {
                ...
                Future<dynamic> checkPermissionAndLocation() {
                  ...
                  return Geo_Location.checkPermissionLocation();
                  //todo:
                }
                ...
                Future<dynamic> getLocationWeather(Position location) async {
                  print('-------location weather-------------- $openWeatherMapURL?lat=${location.latitude}&lon=${location.longitude}&appid=$apiKeyOpenWeatherMap&units=metric');
                ...
                Future<dynamic> getLocationWeatherHourlyForecast(Position location) async {
                  print('---forecast-------------$openWeatherMapHourlyForecastURL?lat=${location.latitude}&lon=${location.longitude}&exclude=minutely&appid=$apiKeyOpenWeatherMap');
                  NetworkingHelper networkingHelper = NetworkingHelper(
                      url: '$openWeatherMapHourlyForecastURL?lat=${location.latitude}&lon=${location.longitude}&exclude=minutely&appid=$apiKeyOpenWeatherMap');
                  var weatherData = await networkingHelper.getData();
                  return weatherData;
                }
                ...
                Future<dynamic> getLocationWeatherHourlyForecastLatLog(double lat, double log) async {
                  NetworkingHelper networkingHelper =
                  NetworkingHelper(url: '$openWeatherMapHourlyForecastURL?lat=$lat&lon=$log&exclude=minutely&appid=$apiKeyOpenWeatherMap');
                  var weatherData = await networkingHelper.getData();
                  return weatherData;
                }
                ...
                Future<dynamic> getLocationAirQualityIndex(Position location) async {
                  print('-------airquality-----------$aqicnAirQualityIndexURL/geo:${location.latitude};${location.longitude}/?token=$apiKeyAqicn');
