import 'package:weatherapp1/components/reusable_card.dart';
import 'package:flutter/material.dart';
import 'package:weatherapp1/services/weather.dart';
import 'package:weatherapp1/components/weatherHourWidget.dart';
import 'package:intl/intl.dart';
import 'package:weatherapp1/components/weatherDayWidget.dart';
import 'package:weatherapp1/components/sunriseAndSunsetWidget.dart';
import 'package:weatherapp1/components/mainDataWidget.dart';
import 'package:weatherapp1/components/airQualityIndexWidget.dart';
import 'package:weatherapp1/screens/SevenDayForecast_screen.dart';
...
class _LocationScreenState extends State<LocationScreen> {
                        ...
                        TextButton(
                          onPressed: () async {
                            ...
                            Prediction prediction = await PlacesAutocomplete.show(
                                context: context,
                                apiKey: 'AIzaSyDJupytI9i_uIaOVj9b0gLYXFYK3H1jPws', //api key from google
  ...
  Future<List> _getLatLng(Prediction prediction) async {
    GoogleMapsPlaces _places = new GoogleMapsPlaces(apiKey: 'AIzaSyDJupytI9i_uIaOVj9b0gLYXFYK3H1jPws'); //Same API_KEY as above
